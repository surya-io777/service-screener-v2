...
class ArguParser:
    ...
    CLI_ARGUMENT_RULES = {
        ...
        "services": {
            ...
            "default": "rds,ec2,iam,s3,efs,lambda,guardduty,cloudfront,cloudtrail,elasticache,eks,dynamodb,opensearch,kms,cloudwatch,redshift,apigateway,sqs,ecs,sagemaker,bedrock,awsconfig,devopsguru,inspector,accessanalyzer,securityhub,route53,systemsmanager,paymentcryptography,ses,xray",
        ...
        "frameworks": {
            "required": False,
            "default": 'MSR,FTR,SSB,WAFS,CIS,NIST,RMiT,SPIP,RBI,SOC2,PCIDSS,HIPAA,GDPR'
        },
        "others":{
            "required": False,
            "default": None,
